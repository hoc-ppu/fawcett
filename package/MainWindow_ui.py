...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:24pt; font-weight:600; color:#79b656;\">Fawcett App </span><span style=\" font-size:14pt; font-weight:600; color:#79b656;\">(v4)</span></p></body></html>"))
