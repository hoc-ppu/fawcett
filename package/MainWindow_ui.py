...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.create_proof_word_btn = QtWidgets.QPushButton(self.frame_2)
        self.create_proof_word_btn.setMaximumSize(QtCore.QSize(450, 16777215))
        self.create_proof_word_btn.setObjectName("create_proof_word_btn")
        self.vboxlayout.addWidget(self.create_proof_word_btn)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.create_proof_word_btn.setText(_translate("MainWindow", "Create Quick Word Proof"))
