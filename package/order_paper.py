...
def rename_xml_file(source_file_name_suffix) -> None:
    ...
    source_file_path = Path(TEMP_DIR_PATH, f'{source_file_name}{source_file_name_suffix}')
...
def order_paper(requested_date, shopping_list) -> None:
    ...
    for requested_data in shopping_list:
        ...
        if (requested_data == 'effectives'):
            ...
            # Get data from the API
            # TODO: what hapends if OP API is avaliable but eqm is not.
    ...
    try:
        ...
        print(f'The following HTML file was created:\n{OUTPUT_FILE_PATH}\n'
